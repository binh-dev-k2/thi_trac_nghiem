                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                            ...
                                                            <li>
                                                                <a href="{{ route('exam.edit.1', $item->id) }}" class="edit">
                                                                    <i class="uil uil-edit"></i>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#" onclick="event.preventDefault();
                                                                document.getElementById('delete-form-{{ $key + 1 }}').submit();" class="remove">
                                                                    <i class="uil uil-trash-alt"></i>
                                                                </a>

                                                                <form action="{{ route('exam.delete', $item->id) }}" method="POST" id="delete-form-{{ $key + 1 }}"  class="d-none">
                                                                    @csrf
                                                                    @method('delete')
                                                                </form>
                                                            </li>
