                  ...
                  <li>
                    <ul>
                      <li class="has-subMenu-left">
                        <a href="#" class="">
                          <img src="{{asset('assets/img/svg/mail.svg')}}" alt="mail" class="svg nav-icon">
                      ...
                      <li>
                        <a href="chat.html" class="">
                          <img src="{{asset('assets/img/svg/message-square.svg')}}" alt="message-square" class="svg nav-icon">
                      ...
                      <li class="has-subMenu-left">
                        <a href="#" class="">
                          <img src="{{asset('assets/img/svg/shopping-cart.svg')}}" alt="shopping-cart" class="svg nav-icon">
                      ...
                      <li class="has-subMenu-left">
                        <a href="#" class="">
                          <img src="{{asset('assets/img/svg/user-check.svg')}}" alt="user-check" class="svg nav-icon">
                      ...
                      <li>
                        <a href="chat.html" class="">
                          <img src="{{asset('assets/img/svg/bookmark.svg')}}" alt="bookmark" class="svg nav-icon">
                          <span class="menu-text">Note</span>
                        </a>
                      </li>
                      <li>
                        <a href="chat.html" class="">
                          <img src="{{asset('assets/img/svg/activity.svg')}}" alt="activity" class="svg nav-icon">
                    ...
                    <ul>
                      <li>
                        <a href="kanban.html" class="">
                          <img src="{{asset('assets/img/svg/columns.svg')}}" alt="columns" class="svg nav-icon">
                          <span class="menu-text">Kanban Board</span>
                        </a>
                      </li>
                      <li class="has-subMenu-left">
                        <a href="#" class="">
                          <img src="{{asset('assets/img/svg/repeat.svg')}}" alt="repeat" class="svg nav-icon">
                      ...
                      <li>
                        <a href="task-app.html" class="">
                          <img src="{{asset('assets/img/svg/clipboard.svg')}}" alt="clipboard" class="svg nav-icon">
                      ...
                      <li class="has-subMenu-left">
                        <a href="#" class="">
                          <img src="{{asset('assets/img/svg/user.svg')}}" alt="user" class="svg nav-icon">
                ...
                <ul class="subMenu">
                  <li>
                    <a href="editors.html" class="">
                      <img src="{{asset('assets/img/svg/edit.svg')}}" alt="svg" class="svg nav-icon">
                  ...
                  <li class="has-subMenu-left">
                    <a href="#" class="">
                      <img src="{{asset('assets/img/svg/bar-chart-2.svg')}}" alt="bar-chart-2" class="svg nav-icon">
                  ...
                  <li class="has-subMenu-left">
                    <a href="#" class="">
                      <img src="{{asset('assets/img/svg/disc.svg')}}" alt="disc" class="svg nav-icon">
                  ...
                  <li class="has-subMenu-left">
                    <a href="#" class="">
                      <img src="{{asset('assets/img/svg/map.svg')}}" alt="map" class="svg nav-icon">
                  ...
                  <li class="has-subMenu-left">
                    <a href="#" class="">
                      <img src="{{asset('assets/img/svg/server.svg')}}" alt="server" class="svg nav-icon">
                  ...
                  <li class="has-subMenu-left">
                    <a href="#" class="">
                      <img src="{{asset('assets/img/svg/square.svg')}}" alt="square" class="svg nav-icon">
                  ...
                  <li class="has-subMenu-left">
                    <a href="#" class="">
                      <img src="{{asset('assets/img/svg/book.svg')}}" alt="book" class="svg nav-icon">
            ...
            <div class="dropdown-custom">
              ...
              <div class="dropdown-parent-wrapper">
                <div class="dropdown-wrapper dropdown-wrapper--small">
                  ...
                  <a href="#"><img src="{{asset('assets/img/iraq.png')}}" alt=""> Arabic</a>
                </div>
              </div>
            </div>
          </li>
