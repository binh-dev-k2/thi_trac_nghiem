                                                    ...
                                                    @foreach ($question as $key => $q)
                                                        <div class="question form-group query">
                                                            <div class="d-flex justify-content-between">
                                                                <label>Câu <span class="question-number">{{ $key + 1 }} </span>:</label>
                                                                <div class="d-flex flex-wrap align-items-center gap gx-4 gy-2">
                                                                    <label>Độ khó:</label>
                                                                    <div>
                                                                        <div class="form-check">
                                                                            <input class="form-check-input radio-difficult" type="radio" name="difficult{{ $key + 1 }}"
                                                                                value="1" {{ $q->level == 1 ? 'checked' : '' }}>
                                                                    ...
                                                                    <div>
                                                                        <div class="form-check"><input class="form-check-input radio-difficult" type="radio"
                                                                                name="difficult{{ $key + 1 }}" value="3" {{ $q->level == 3 ? 'checked' : '' }}>
                                                            ...
                                                            <div class="row mb-3">
                                                                <div class="col-11">
                                                                    <div class="form-control-wrap">
                                                                        <input class="form-control question-input" type="text" name="question"
                                                                        ...
                                                                        <div class="col-11">
                                                                            <div class="form-check row">
                                                                                <input class="form-check-input correct-answer-radio"
                                                                                    style="width: 1.5rem; height: 1.5rem" type="radio" name="correct-answer{{ $key + 1 }}" {{ $a->status == 1 ? 'checked' : '' }}>
                                                                                <div class="form-control-wrap">
                                                                                    <input class="form-control answer-input" type="text" name="answer" value="{{ $a->content }}"
                                                                                        required>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="question form-group query">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div class="d-flex flex-wrap align-items-center gap gx-4 gy-2">
                                                            ...
                                                            <div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input radio-difficult" type="radio" name="difficult"
                                                                        value="1">
                                                                    <label class="form-check-label">Dễ</label>
                                                                </div>
                                                            </div>
            ...
            submitForm: function() {
                ...
                formElement.onsubmit = function(e) {
                    ...
                    if (!x || !y) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '{{ route('api.exam.update.2', $id) }}',
                            headers: {
