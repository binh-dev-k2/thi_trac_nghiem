                                                        ...
                                                        <div class="d-flex flex-wrap align-items-center gap gx-4 gy-2">
                                                            ...
                                                            <div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input radio-difficult" type="radio"
                                                            ...
                                                            <div>
                                                                <div class="form-check"><input class="form-check-input radio-difficult"
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-11">
                                                            <div class="form-control-wrap">
                                                                <input class="form-control question-input" type="text"
    ...
    submitForm: function () {
        ...
        formElement.onsubmit = function (e) {
            ...
            if (!x || !y) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('api.exam.create.2', $id) }}',
                    headers: {
